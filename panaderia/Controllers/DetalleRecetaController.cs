...
namespace panaderia.Controllers
{
    public class DetalleRecetaController : Controller
    {
        ...
        {
            var data = new AgregarRecetaData();
            ...
            data.producto = db.producto.ToList();
            data.receta = db.receta.ToList();
            data.medida = db.medida.ToList();
            data.detalle_receta = recetas;
            data.idSeleccionado = id;
            return View(data);
        }
