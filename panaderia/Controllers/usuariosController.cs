...
namespace panaderia.Controllers
{
    ...
    public class usuariosController : Controller
    {
        ...
        {
            var usuario = db.usuario.Include(u => u.rolusuario);
        ...
        {
            ViewBag.rolusuarioId = new SelectList(db.rolusuario, "Id", "rol");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,nombre,clave,rolusuarioId")] usuario usuario)
        {
            if (ModelState.IsValid)
            {
